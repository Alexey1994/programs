...
static Byte* get_default_console_writer();
static void  set_console_color(Byte* console, Console_Color text_color, Console_Color background_color);
static void  write_in_console(Byte* console, Byte* charachters, Number number_of_charachters);
static void  write_character_in_console(Byte* console, Number32 charachter);
static Byte* get_default_console_reader();
