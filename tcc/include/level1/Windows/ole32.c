...
Number32 main()
{
	...
	extract_image = extract_image_object.this[0];

	print(
		_Number, extract_image->unknown.AddRef(extract_image_object.this)
		//_Number, extract_image->Extract(extract_image_object.this, 0)
	);
