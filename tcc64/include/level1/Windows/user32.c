...
import Number32          PeekMessageA     (Windows_Message* message, Byte* window, Number32 filter_min, Number32 filter_max, Remove_Message_From_Queue remove_type);
import Integer_Number32  DispatchMessageA (Windows_Message* message);
import Integer_Number32  DispatchMessageW (Windows_Message* message);
...
import Number32          GetMessageW      (Windows_Message* message, Byte* window, Number32 filter_min, Number32 filter_max);
import Number32          SendMessageA     (Byte* window, Windows_Message_Type type, Number16 short_parameter, Number32 long_parameter);
import Number32          SendMessageW     (Byte* window, Windows_Message_Type type, Number16 short_parameter, Number32 long_parameter);
import Boolean           PostMessageA     (Byte* window, Windows_Message_Type type, Number16 short_parameter, Number32 long_parameter);
import Boolean           PostMessageW    (Byte* window, Windows_Message_Type type, Number16 short_parameter, Number32 long_parameter);
...
typedef struct
{
	...
	stdcall Number32 (*window_procedure)(Byte* window, Windows_Message_Type type, Number32* parameters_1, Integer_Number32* parameters_2);
	Number32           class;
	Number32           window;
	Number16*          instance;
	Icon*              icon;
...
import Boolean  ShowScrollBar    (Byte* window, Scroll_Bar_Type scrollbar_index, Boolean show);
import Byte*    SetFocus         (Byte* window);
...
import Number32 DefWindowProcA   (Byte* window, Windows_Message_Type type, Number16* parameter1, Number32* parameter2);
import Number32 DefWindowProcW   (Byte* window, Windows_Message_Type type, Number16* parameter1, Number32* parameter2);
