...
void print_camera_info(Number32 device_index);
void create_camera(
...
#include <system/Windows/avicap32.c>
...
)
{
	...
	window = capCreateCaptureWindowA("Camera preview", /*POPUP_WINDOW_STYLE*/0x10000000 | 0x00800000, 0, 0, 640, 480, 0, 0);
