...
static void initialize_writer(Writer* writer, Byte* source, Integer_Number32 (*write_bytes)(Byte* source, Byte* bytes, Number32 size_of_bytes))
{
...
static void write_Number64(Writer* writer, Number64 number)
{
/*
#ifdef __WIN32__
...
/*
static void write_Rational_Number(Writer* writer, Rational_Number number)
{
	Number   number_copy;
	Number32 right_selector;
...
static void write_Number64_triplets(Writer* writer, Number64 number)
{
	/*
#ifdef __WIN32__
	Number64 number_copy;
...
static void write_null_terminated_words(Writer* writer, Number16* words)
{
	for(; *words; ++words)
...
static Byte* _Number = &write_Number;
static Byte* _Number64 = &write_Number64;
static Byte* _Number64_triplets = &write_Number64_triplets;
static Byte* _hex_Number32 = &write_hex_Number32;
static Byte* _hex_Number16 = &write_hex_Number16;
static Byte* _null_terminated_words = &write_null_terminated_words;
//static Byte* _Rational_Number = &write_Rational_Number;


static void print_in_writer(Writer* writer, ...)
{
