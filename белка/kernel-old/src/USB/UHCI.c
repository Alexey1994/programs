#ifndef USB_UHCI_INCLUDED
#define USB_UHCI_INCLUDED
...
void configure_USB_UHCI_device(PCI_Device* device)
{
	Number16 io_base;

	io_base = get_PCI_IO_address(device, 4);
	...
	print(
		_Number, in_16(io_base + UHCI_COMMAND_CONTROLLER_RESET),
		"\n"
	);
}


#endif//USB_UHCI_INCLUDED